...
print("🌌 v1.6.4 — Stable Magnetic Energy Evolution (Fixed)")
...
mu0 = 4 * np.pi * 1e-7
eta = 0.0025          # Higher resistivity for stability
dt = 0.00025
steps = 500
max_v = 350 * 1000.0
...
J_z = 8.0e17 * np.exp(-r_cyl**2 / (2*7.5**2))   # Reduced current
...
plt.suptitle('v1.6.3 Stable Magnetic Energy Evolution')
plt.tight_layout()
plt.show()
