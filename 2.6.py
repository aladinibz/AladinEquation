...
print("🌌 Plasma Cosmology v2.6 — Fixed Staggered Grid Indexing")
...
print("Starting v2.6 with fixed staggered indexing...\n")
...
plt.suptitle('Plasma Cosmology v2.5 — Full CT with Fixed Indexing')
plt.tight_layout()
plt.show()
